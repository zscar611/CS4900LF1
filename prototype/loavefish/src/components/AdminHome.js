      ...
      <div className="row">
        ...
        <div className="column">
          <div className="adminHome-box">
            ...
            <p className="adminHome-text">Checked In: Charles Leclerc, Max Verstappen, Lewis Hamilton</p>
          </div>
        </div>
        <div className="column">
          <div className="adminHome-box">
            ...
            <p className="adminHome-text">Checked In: Carlos Sainz, George Russell, Alex Albon</p>
          </div>
        </div>
      </div>
      <div className="row">
        <div className="column">
          <div className="adminHome-box">
            ...
            <p className="adminHome-text">Checked In: Yuki Tsunoda, Daniel Ricciardo, Pierre Gasly</p>
          </div>
        </div>
        <div className="column">
          <div className="adminHome-box">
